...
public class MeshBuilder
{
    ...
    public void AddQuad(int vertexIndex1, int vertexIndex2, int vertexIndex3, int vertexIndex4, int subMeshNumber = 0)
    {
        AddTriangle(vertexIndex1, vertexIndex2, vertexIndex3, subMeshNumber);
        AddTriangle(vertexIndex1, vertexIndex3, vertexIndex4, subMeshNumber);
    }
